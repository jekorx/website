        ...
        then
            ...
            then
                ...
                then
                    ...
                    sed -i '/<\/body>/i <script type="text/javascript" color="77,77,77" opcity="0.77" count="77" src="https://cdn.bootcdn.net/ajax/libs/canvas-nest.js/2.0.4/canvas-nest.js"></script>' $1"/"$file
                fi
            fi
        fi
    done
